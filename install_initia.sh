...
echo "Decompressing the snapshot..."
lz4 -c -d initia_snapshot.tar.lz4 | tar -x -C $HOME/.initia/data

# Removing the downloaded snapshot to free up space
echo "Removing the downloaded snapshot..."
rm -v initia_snapshot.tar.lz4

# Restarting initiad service
echo "Restarting initiad service..."
sudo systemctl restart initiad

# Waiting for syncing to complete
...
# Restart initiad service and view logs
echo "Restarting initiad service and viewing logs..."
